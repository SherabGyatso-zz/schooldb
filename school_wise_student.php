...
<table  class="table table-bordered table-striped table-hover table-condensed table-responsive">
    <thead >
            ...
            <td colspan="21" align="center" >
              <?php
                ...
                <form action="" method="POST" class="print_disable">
                    ...
                    <select name="dl" style="font-size: 18px;" class="print_disable">
                        <?php
        ...
        ?>
               <h2>School Wise Student Enrolment As On <?php echo gmdate("F j, Y", strtotime($_POST['dl'])); ?> </h2>
                </td>
            </tr>
               ...
               foreach ($h_student_data as $row) {
                   ...
                   ?>
                    ...
                    <tr>
                        ...
                        <td style="color: #f00; align:center"><?php echo $row['Grand Total']; ?></td>
