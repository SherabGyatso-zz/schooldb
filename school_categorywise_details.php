...
<table  class="table table-bordered table-striped table-hover table-condensed table-responsive">
    <thead >
        ...
        ?>
               <h2 style="color:#f00" align="center">School Category Wise Student Enrolment As On <?php echo gmdate("F j, Y", strtotime($_POST['dl'])); ?> </h2>
                </td>
            </tr>
           ...
           $sch_cat= array('2'=>'CST','4'=>'THF','6'=>'Snow Lion Foundation','3'=>'STSS','1' => 'TCV','5'=>'Private Tibetan Schools', );
        //print_r($sch_cat);
        foreach($sch_cat as $cat) {
if($cat =='CST'){
      echo '<tr><th colspan="20"><h2 style="color:#00f" align="center">Central Tibetan Schools Administration(CTSA)</h2></th></tr>';
     $h_student_data = $school->get_school_category_result($dl_cond,2);
 }elseif($cat =='THF'){
      echo '<tr><th colspan="20"><h2 style="color:#00f" align="center">Tibetan Home Foundation(THF)</h2></th></tr>';
     $h_student_data = $school->get_school_category_result($dl_cond,4);
 }elseif($cat =='Snow Lion Foundation'){
      echo '<tr><th colspan="20"><h2 style="color:#00f" align="center">Snow Lion Foundation, Nepal</h2></th></tr>';
     $h_student_data = $school->get_school_category_result($dl_cond,6);
 }elseif($cat =='STSS'){
    echo '<tr><th colspan="20"><h2 style="color:#00f" align="center">Sambhota Tibetan Schools Society(STSS)</h2></th></tr>';
     $h_student_data = $school->get_school_category_result($dl_cond,3);
 }elseif($cat == 'TCV') {
    echo '<tr><th colspan="20"><h2 style="color:#00f" align="center">Tibetan Children Village(TCV)</h2></th></tr>';
     $h_student_data = $school->get_school_category_result($dl_cond,1);
 }else {
      echo '<tr><th colspan="20"><h2 style="color:#00f" align="center">Private Tibetan Communities</h2></th></tr>';
     $h_student_data = $school->get_school_category_result($dl_cond,5);
 }
